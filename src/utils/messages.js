...
export const messages = [
  ...
  'Some ideas are better when they\'re half-baked...Just like cookies. Gooey on the inside is where it\'s at.',
  ...
  'Don\'t judge a book by its cover. Judge it by the dedication. "To Mom" or nothing.',
  'Ever read a book about gravity? They\'re impossible to put down!',
  'You know what I say? A table of contents is just an index without spoilers.',
  'Eyeballs are like windows so your brain can look outside, and your brain needs that sunshine!',
  ...
  'Herding cats is hard. But you know what\'s harder? Herding crocodiles. Man, they\'ve got some attitude!',
  'It\'s always a good deal to buy something half off. You usually still get the full thing anyway.',
  'DJs better watch it. If they keep droppin\' the bass, they\'re gonna break it. But then we\'ll all end up payin\'.',
  'Have you ever noticed there are rock stars but no roll stars? Whatever happened to rock AND roll?',
  'Music is just air gettin\' its dance on. We\'re all breathing shy songs that want to cut a rug.',
  'Making friends is a lot like making music. It\'s a soundtrack for your life, wrong notes and all.',
  ...
  'How come everyone\'s always askin\' where people are from? What I wanna know is: Where you goin\'?',
  'If you wanna get ahead in life, you gotta pick a direction first!',
  'If your philosophy can\'t be summed up in three words on a T-shirt, it\'s just too much work.',
  'It\'s OK to be a couch potato. Just don\'t be a bed yam. That\'s just not cool.',
  ...
  'Magic is just science with your eyes closed.',
  'Six is afraid of seven because seven ate nine. But, it was a setup! The real culprit? Negative seven.',
  'Studying astronomy and "taking up space" in school two...totally different things.',
  'We should tell rainbows it\'s OK to relax. They\'re always so intense. We put too much pressure on them.',
  'When you can\'t sleep, you gotta wonder if maybe sleep just can\'t YOU.',
  'Whoever said you only sink or swim must not know about pool noodles.',
